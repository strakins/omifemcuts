      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-4xl">
            <h1 className="-mt-10 md:-mt-0 text-2xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              Elevate Your Style With 
              <span className="text-blue-400"> Premium Tailoring</span>
            </h1>
            
            <p className="text-sm md:text-2xl text-gray-200 mb-8 max-w-2xl pt-20">
